...
if __name__ == '__main__':
    ...
    #                    r'examplesplit')
    #####################################
    # input = 416x416 overlap = 15%
    # split = splitbase('E:\Study\YOLT\example\images',
    #                    'E:\Study\YOLT\split_416x416_15overlap',
    #                     subsize=416,
    #                     gap=62) 
    ##################################### 
    # input = 544x544 overlap = 15%
    # split = splitbase('E:\Study\YOLT\example\images',
    #                    'E:\Study\YOLT\split_544x544_15overlap',
    #                     subsize=544,
    #                     gap=82)
    ####################################
    # split = splitbase('E:\Study\YOLT\example\images',
    #                    'E:\Study\YOLT\split_608x608_15overlap',
    #                     subsize=608,
    #                     gap=91)    
    #####################################
    split = splitbase('E:\Study\YOLT\example\yolov2test',
                       'E:\Study\YOLT\example\yolov2split_1024',
                        subsize=1024,
                        gap=100)  
    #####################################
    # input = 1024x1024 overlap = 15%
    # split = splitbase('E:\Study\YOLT\example\images',
    #                    'E:\Study\YOLT\split',
    #                     subsize=416,
    #                     gap=153)   
